	...
	<form method="post" name="creatediscipline" id="creatediscipline" class="validate" enctype="multipart/form-data"
		...
		<table class="form-table">
			<tbody>
				...
				<tr class="form-field">
					<th scope="row"><label for="photo_small">Photo (small) <span class="description">(355px x 275px)</span></label></th>
					<td><img id="photo_img_small" src="#" alt="Preview Small Photo" /> <input type="file" name="photo_small" id="photo_small"></td>
				</tr>
			</tbody>
		</table>
