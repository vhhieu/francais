<?php
/**
 * Admin View: Main Menu - Francias - Category - Edit
 *
 * @var string $view
 */
if (! defined ( 'ABSPATH' )) {
...
if ($_SERVER['REQUEST_METHOD'] === "GET") {
	if (isset($_REQUEST['movie'])) {
		global $wpdb;
		$sql = "SELECT * FROM " . $wpdb->prefix . "francais_category WHERE category_id = %d";
...
<div class="wrap">
	...
	<form method="post" name="updatecategory" id="updatecategory" class="validate" enctype="multipart/form-data"
		...
		<input name="category_id" type="hidden" id="category_id" value="<?= $data['category_id'] ?>"/>
			...
			<tbody>
				...
				<tr class="form-field">
					...
					<td><select name="age_group" id="age_group" class="selectbox-general">
							<option <?php echo $data['age_group'] == "" ? "selected='selected'" : ""?> value="">Neutre</option>
				...
				<tr class="form-field form-required">
					...
					<td>
						...
						wp_editor($data["description_with_city"], "descriptionwithcity", $settings);
						?>
					</td>
				</tr>
				<tr class="form-field form-required">
				...
				<tr class="form-field form-required">
					...
					<td>
						<input id="title_with_city" name="title_with_city" type="text" value="<?= $data['title_with_city'] ?>"> 
					</td>
				</tr>
				<tr class="form-field form-required">
					<th scope="row"><label for="meta_keyword">Meta Keyword <span class="description">(required)</span></label></th>
					<td>
						<input id="meta_keyword" name="meta_keyword" type="text" value="<?= $data['meta_keyword'] ?>"> 
					</td>
				</tr>
				<tr class="form-field form-required">
					<th scope="row"><label for="meta_keyword_with_city">Meta Keyword (Ville) <span class="description">(required)</span></label></th>
					<td>
						<input id="meta_keyword_with_city" name="meta_keyword_with_city" type="text" value="<?= $data['meta_keyword_with_city'] ?>"> 
					</td>
				</tr>
				<tr class="form-field form-required">
					<th scope="row"><label for="meta_description">Meta Description <span class="description">(required)</span></label></th>
					<td>
						<textarea rows="4" cols="50" id="meta_description" name="meta_description"><?= $data['meta_description'] ?></textarea> 
					</td>
				</tr>
				<tr class="form-field form-required">
					<th scope="row"><label for="meta_description_with_city">Meta Description (Ville) <span class="description">(required)</span></label></th>
					<td>
						<textarea rows="4" cols="50" id="meta_description_with_city" name="meta_description_with_city"><?= $data['meta_description_with_city'] ?></textarea> 
					</td>
				</tr>
		...
		<p class="submit">
			<input type="submit" name="updatecategorysubmit" id="updatecategorysubmit"
